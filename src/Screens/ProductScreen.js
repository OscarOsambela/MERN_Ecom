...
export default function ProductScreen(props) {
  ...
  useEffect(() => {
    if (successReviewCreate) {
      window.alert('Review enviado exitósamente');
      setRating('');
      setComment('');
  ...
  const submitHandler = (e) => {
    ...
    if (comment && rating) {
      ...
      alert('Por favor, ingresa un comentario y puntuación');
    }
  };
              ...
              <li>
                {userInfo ? (
                  <form className="form" onSubmit={submitHandler}>
                    <div>
                      <h2>Escribe un comentario de cliente</h2>
                    </div>
                    <div>
                      <label htmlFor="rating">Puntación</label>
                      <select
                        id="rating"
                        value={rating}
                  ...
                  <MessageBox>
                    Por favor <Link to="/signin">ingresa</Link> para agregar un comentario
                  </MessageBox>
                )}
              </li>
            </ul>
